...
operate on different data layers than Upsilon:
...
- **Tier 3 (Upsilon — us):** cascade architecture. "Your leverage is 259×,
...
only Upsilon has.** The cascade is the moat. signa is the agent that reads the
